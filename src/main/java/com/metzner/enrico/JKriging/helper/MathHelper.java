...
//        c
		afac = 1d / Math.max(anis,Constants.D_EPSLON);
		rotmat[ind-1][0] =      ( cosa);
		rotmat[ind-1][1] =      ( sina);
...
//        c
	 ...
	 * @return
	 */
	public static double[][][] setrot3D(double ang1, double ang2, double ang3, double anis1, double anis2, int ind, int maxrot, double[][][] rotmat) {
//        c-----------------------------------------------------------------------
//        c
//        c              Sets up an Anisotropic Rotation Matrix
//        c              **************************************
